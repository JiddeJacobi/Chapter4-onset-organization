...
cor(sp.CC$time.lag.norm, sp.CC$dur.C1.norm, use = "complete.obs")
ggplot(sp.CC, aes(x=time.lag.norm, y=dur.C1.norm)) + geom_point(size = 1, shape= 1) + theme_bw() + labs(title = "Inter plateau interval vs. duration of C1, /sp/" )

cor(sp.CC$time.lag.norm, sp.CC$dur.C2.norm, use = "complete.obs")
ggplot(sp.CC, aes(x=time.lag.norm, y=dur.C2.norm)) + geom_point(size = 1, shape= 1) + theme_bw() + labs(title = "Inter plateau interval vs. duration of C2, /sp/")
...
cor(sm.CC$time.lag.norm, sm.CC$dur.C1.norm, use = "complete.obs")
ggplot(sm.CC, aes(x=time.lag.norm, y=dur.C1.norm)) + geom_point(size = 1, shape= 1) + theme_bw() + labs(title = "Inter plateau interval vs. duration of C1, /sm/")

cor(sm.CC$time.lag.norm, sm.CC$dur.C2.norm, use = "complete.obs")
ggplot(sm.CC, aes(x=time.lag.norm, y=dur.C2.norm)) + geom_point(size = 1, shape= 1) + theme_bw() + labs(title = "Inter plateau interval vs. duration of C2, /sm/")
...
cor(sx.CC$time.lag.norm, sx.CC$dur.C1.norm, use = "complete.obs")
ggplot(sx.CC, aes(x=time.lag.norm, y=dur.C1.norm)) + geom_point(size = 1, shape= 1) + theme_bw() + labs(title = "Inter plateau interval vs. duration of C1, /sx/")

cor(sx.CC$time.lag.norm, sx.CC$dur.C2.norm, use = "complete.obs")
ggplot(sx.CC, aes(x=time.lag.norm, y=dur.C2.norm)) + geom_point(size = 1, shape= 1) + theme_bw() + labs(title = "Inter plateau interval vs. duration of C2, /sx/")
...
cor(spr.CC$time.lag.norm, spr.CC$dur.C1.norm, use = "complete.obs")
ggplot(spr.CC, aes(x=time.lag.norm, y=dur.C1.norm)) + geom_point(size = 1, shape= 1) + theme_bw() + labs(title = "Inter plateau interval vs. duration of C1, /spr/")

cor(spr.CC$time.lag.norm, spr.CC$dur.C2.norm, use = "complete.obs")  
ggplot(spr.CC, aes(x=time.lag.norm, y=dur.C2.norm)) + geom_point(size = 1, shape= 1) + theme_bw() + labs(title = "Inter plateau interval vs. duration of C2, /spr/")

cor(spr.CC$time.lag.norm, spr.CC$dur.C3.norm, use = "complete.obs")
ggplot(spr.CC, aes(x=time.lag.norm, y=dur.C3.norm)) + geom_point(size = 1, shape= 1) + theme_bw() + labs(title = "Inter plateau interval vs. duration of C3, /spr/")
rm(offset.s)
